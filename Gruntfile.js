    ...
    grunt.initConfig({
        ...
        jshint: {
            ...
            all: [
                ...
                '!<%= yeoman.client %>/{app,components}/**/*.spec.js',
                '!<%= yeoman.client %>/{app,components}/**/*.mock.js',
                '!<%= yeoman.client %>/{app,components}/**/s2viz/**/*.js'
            ],
            test: {
                src: [
                    '<%= yeoman.client %>/{app,components}/**/*.spec.js',
        ...
        rev: {
            dist: {
                files: {
                    src: [
                        '<%= yeoman.dist %>/public/{,*/,Chart.js/}*.{js}',
        ...
        usemin: {
            ...
            js: ['<%= yeoman.dist %>/public/{,*/,Chart.js/}*.{js}'],
            options: {
                assetsDirs: [
                    '<%= yeoman.dist %>/public',
        ...
        buildcontrol: {
            ...
            github: {
                options: {
                    remote: 'https://github.com/matsuzawalab/kf6-release.git',
                    branch: 'master',
                    tag: '<%= pkg.version %>'
                }
            },
